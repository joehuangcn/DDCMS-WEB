  ...
  render() {
    ...
    <div className="tabs_all" style={{height:'100%'}}>
      <Tabs type="card" style={{height:'100%'}} activeKey={activeKey}  onChange={this.callback}>
        ...
        <TabPane tab="差异展示分类" key="5"><DiffType config={config} permission={permission} /></TabPane>
        <TabPane tab="上传日志" key="6"><SynchLog config={config} permission={permission} /></TabPane>
