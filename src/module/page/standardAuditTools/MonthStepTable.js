...
class MonthStepTable extends Component{
  ...
  getDynColumnHead =() =>{
    ...
    const firtColumns =[
      ...
      { title: 'SP企业代码',dataIndex: 'spCode',key: 'spCode',width:120,},
      { title: '业务代码',dataIndex: 'businessProductCode',key: 'businessProductCode',width:120,},
      { title: '业务产品名称',dataIndex: 'businessProductName',key: 'businessProductName',width:120,},
      {title: '一致总量',dataIndex: 'sameTotal',key: 'sameTotal',width:150},
      {title:'一致率',dataIndex:'samePercen',key:'samePercen',width:150},
      {title:'BOSS多',
        children:[
          {title:'差异总量',dataIndex:'differenceTotalBoss',key:'differenceTotalBoss',width:150},
          {title:'差异总金额',dataIndex:'differenceTotalAmountBoss',key:'differenceTotalAmountBoss',width:150},
      ...
      {title:'平台多',
        children:[
          {title:'差异总量',dataIndex:'differenceTotalPlatform',key:'differenceTotalPlatform',width:150},
          {title:'差异总金额',dataIndex:'differenceTotalAmountPlatform',key:'differenceTotalAmountPlatform',width:150},
          {title:'资费类型',
            children:[
...
exportMes=(e)=>{
   ...
   let downflag='';
   const {startDate,endDate}=this.state;
   let text="type=1&startDate="+startDate+"&endDate="+endDate;
   if (e.key==='1') {
